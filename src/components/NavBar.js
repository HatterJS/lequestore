  ...
  return (
    <nav>
      <div className="navBar">
        ...
        <div
          className="navBar__filterButton unselectable"
          style={
            !filterStatus() ? { backgroundColor: 'rgb(255, 245, 170)' } : { backgroundColor: '' }
          }
          onClick={showFilter}>
          ФІЛЬТР
        </div>
