...
function Address(props) {
  ...
  const addToCartSVG = (
    <svg width="50" height="50" viewBox="0 0 50 50" fill="none">
      <path
        d="M13 17.1081C13 16.5558 13.4477 16.1081 14 16.1081H37C37.5523 16.1081 38 16.5558 38 17.1081V36.1081C38 38.8695 35.7614 41.1081 33 41.1081H18C15.2386 41.1081 13 38.8695 13 36.1081V17.1081Z"
        fill="#FFE500"
        stroke="#8C8C8C"
        strokeWidth="2"
      />
      ...
      />
      <path
        d="M19.7567 19.1486V14.0811C19.7567 10.7226 22.4793 8 25.8378 8C29.1963 8 31.9189 10.7226 31.9189 14.0811V19.1486"
        stroke="#8C8C8C"
        strokeWidth="2"
        strokeLinecap="round"
      />
  ...
  return (
    <address>
      <div className="addressBlock">
        <Link to="/">
          <img className="addressBlock__logo" src="/img/logo.webp" alt="Lequestore" />
        </Link>
        ...
        <div className="addressBlock__favoriteCart unselectable">
          ...
          <div className="addressBlock__cartBlock">
            <div className="addressBlock__cart" onClick={() => dispatch(openCart())}>
              {addToCartSVG}
